...
export class BlogsService {
  ...
  private key = 'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTcxODc5NDYxMywiYXV0aCI6IlJPTEVfQURNSU4gUk9MRV9VU0VSIiwiaWF0IjoxNzE4NzA4MjEzfQ.bt4P1JANCSI-I89Gc2TbDq_W6yFm7vcMBH0hOa1RyXrbcx_8Jb_5vV7cbygLXxClGiqFph7uFWGv9VIuuw1s4A';
  ...
  updateBlog(blog: Blog): Observable<any> {
    ...
    return this.http.put(`${this.apiUrl}/${blog.id}`, blog, { headers }); //para
  }
}
